        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              <h4>Olayemi Israel</h4>
              <p><em>Innovative and deadline-driven Web Designer with years of experience designing and developing user-centered digital/print marketing material from initial concept to final, polished deliverable.</em></p>
              <p>
              <ul>
                <li>Nigeria Airforce Base
                  Ikeja, Lagos State. Nigeria.</li>
                <li>(234) 81 809 804 19
                </li>
                <li>olayemisrael5@gmail.com
                </li>
              </ul>
              </p>
            </div>
            ...
            <div class="resume-item">
              <h4>Web Development &amp; Web Design</h4>
              <h5>2019 - PRESENT</h5>
              <p><em>Code Learners, Ikeja.</em></p>
              <p>Relevant Coursework: Website design, User Experience, Database
                Administration, Web Page Programming, System Administration.</p>
            </div>
            ...
            <div class="resume-item">
              ...
              <ul>
                <li>Front End Web Developer
                  Certification By W3C
                  </li>
                <li>Code Learners Full stack Web
                  Developer Certification</li>
                <li>Front End Web UI
          ...
          <div class="col-lg-6">
            ...
            <div class="resume-item">
              <h4>Web Development &amp; Web Design</h4>
              <ul>
                <li>HyperTech Markup Language
                  (HTML)
                  </li>
                <li>Java Script (JS)</li>
                <li>Hypertext Preprocessor
                  (PHP)</li>
                  <li>Cascading Style Sheet (CSS)</li>
                    <li>Structured Query
                      Language(SQL)</li>
                      <li>Responsive Design and
                        Mobile First Website</li>
              </ul>
            </div>
          </div>
        </div>
