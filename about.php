  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>My name is Olayemi Israel, I'm a Website Developer from Ikeja, Lagos. Nigeria.</p>
        </div>

        <div class="row">
          <div class="col-lg-4">
            <img src="assets/img/FB_IMG_1616016563372.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            <h3>Developer &amp; Designer</h3>
            <p class="fst-italic">
              I'm a full stack website designer/developer with years of experience...
              expert in html, CSS, bootstrap, react, java script, PHP, my SQL etc.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-rounded-right"></i> <strong>Birthday:</strong> 20th Oct 1998.</li>
                  <li><i class="bi bi-rounded-right"></i> <strong>Website:</strong> github.com/Hisrahel</li>
                  <li><i class="bi bi-rounded-right"></i> <strong>Phone:</strong> +234 81 809 804 19</li>
                  <li><i class="bi bi-rounded-right"></i> <strong>Location:</strong> Ikeja, Lagos. Nigeria.</li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-rounded-right"></i> <strong>Email:</strong> Olayemisrael5@gmail.com</li>
                  <li><i class="bi bi-rounded-right"></i> <strong>Freelance:</strong> Available</li>
                </ul>
              </div>
            </div>
            <p>
             I'm officially available for Internship trainings, tutoring and mentorship... Also open for jobs opportunities.
            </p>
          </div>
        </div>
    ...
    <section id="skills" class="skills">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Skills</h2>
          <p>HTML, CSS, Bootstrap, PHP, Java Script, Word Press, My SQL Data Base</p>
        </div>
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Java Script<i class="val">50%</i></span>
              <div class="progress-bar-wrap">
    ...
    <section id="facts" class="facts">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Facts</h2>
          <p>I'm good, Competent and Hardworking... I deliver jobs to clients before the due dates.
            I love to teach and Impact on young and up and coming developers.
          </p>
        </div>
